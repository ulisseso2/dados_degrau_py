(SELECT
    ...
    CAST(NULL AS CHAR(50)) as status_parcela,
    CAST(NULL AS SIGNED) as id_pagamento
...
(SELECT 
    ...
    CAST(f.company_name as CHAR(255)) as fornecedor,
    CAST(b.name AS CHAR(255)) as conta_bancaria,
    CAST(ps.name AS CHAR(50)) as status_parcela,
    CAST(po.id AS SIGNED) as id_pagamento
...
LEFT JOIN seducar.purchase_order_installment_status ps ON poi.purchase_order_installment_status_id = ps.id
